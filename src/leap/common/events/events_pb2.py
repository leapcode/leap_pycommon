...
_EVENT = descriptor.EnumDescriptor(
  ...
  values=[
    ...
    descriptor.EnumValueDescriptor(
      ...
      type=None),
    descriptor.EnumValueDescriptor(
      name='KEYMANAGER_LOOKING_FOR_KEY', index=35, number=40,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='KEYMANAGER_KEY_FOUND', index=36, number=41,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='KEYMANAGER_KEY_NOT_FOUND', index=37, number=42,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='KEYMANAGER_STARTED_KEY_GENERATION', index=38, number=43,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='KEYMANAGER_FINISHED_KEY_GENERATION', index=39, number=44,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='KEYMANAGER_DONE_UPLOADING_KEYS', index=40, number=45,
      options=None,
      type=None),
  ],
